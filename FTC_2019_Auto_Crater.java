...
@Autonomous(name="FTC_2019_Auto_Crater", group="Iterative Opmode")
    

public class FTC_2019_Auto_Crater extends LinearOpMode
{
    // Object Detection 
    ...
    public void runOpMode() {
        ...
        motor_back_right.setPower(motor_back_right_power);
        sleep(1200);
        drive(Direction.RIGHT, 100);
        speed = 0.7;
        drive(Direction.BACKWARD, 1500);
        // drop teammarker
        servo_marker.setPosition(0.4);
