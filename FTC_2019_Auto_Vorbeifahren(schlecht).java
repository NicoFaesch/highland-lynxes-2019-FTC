...
public class FTC_2019_Auto extends LinearOpMode
{
    ...
    private void drive(Direction direction, int angle) {
        /*
        //set ideal speed if robot is checking for gold
        if(checkGold)
        {
            speed = 0.2;
        }
        */
        //set direction of motors for wanted direction
        switch (direction) {
            case FORWARD:
            ...
            if (opModeIsActive()) {
                if (tfod != null) {
                    while (opModeIsActive() && (isRunning > 0)) {
                        ...
                        if (updatedRecognitions != null  && detected == false) {
    ...
    private void initTfod() {
        ...
        tfodParameters.minimumConfidence = 0.05;
    ...
    public void runOpMode() {
        ...
        motor_latching.setTargetPosition(motor_latching.getCurrentPosition() + 5400);
        ...
        servo_marker.setPosition(1);
            ...
            motor_arm.setTargetPosition(860);
            motor_arm.setPower(0.25);
            motor_latching.setTargetPosition(motor_latching.getCurrentPosition() + 1950);
            motor_latching.setPower(1);
            sleep(10000);
            /*
            servo_arm_left.setPosition(0.8);
